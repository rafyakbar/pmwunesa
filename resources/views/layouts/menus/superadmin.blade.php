...
<li @if(Route::currentRouteName() === 'daftar.pengguna' ) class="active" @endif>
    <a href="{{ route('daftar.pengguna', ['fakultas'=>'semua_fakultas', 'role' => 'semua_hak_akses', 'data' => 10, 'q' => '[]']) }}">
...
<li @if(Route::currentRouteName() === 'daftar.proposal' ) class="active" @endif>
    <a href="{{ route('daftar.proposal', ['fakultas' => 'semua_fakultas', 'lolos' => 'semua_proposal', 'perHalaman' => 10, 'period' => 'semua_periode']) }}">
